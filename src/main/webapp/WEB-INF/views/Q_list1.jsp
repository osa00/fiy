...
<BODY>
<center>
	<form id="user" Method="post" Name="joinForm" method="post">
		...
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_1/1-11.png" onclick="Check()"></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_1/1-22.png" onclick="Check2()"/></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_1/1-33.png" onclick="Check3()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_1/1-44.png" onclick="Check4()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_1/1-55.png" onclick="Check5()" /></TD>
			</TR>
		</TABLE>
		<br>
