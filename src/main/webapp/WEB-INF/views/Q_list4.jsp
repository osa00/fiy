	...
	<form id="user" Method="post" Name="joinForm"
		...
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_4/4-11.png" onclick="Check()"></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_4/4-22.png" onclick="Check2()"/></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_4/4-33.png" onclick="Check3()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_4/4-44.png" onclick="Check4()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_4/4-55.png" onclick="Check5()" /></TD>
			</TR>
		</TABLE>
		<br>
