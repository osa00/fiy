	...
	<form id="user" Method="post" Name="joinForm"
		...
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_3/3-11.png" onclick="Check()"></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_3/3-22.png" onclick="Check2()"/></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_3/3-33.png" onclick="Check3()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_3/3-44.png" onclick="Check4()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_3/3-55.png" onclick="Check5()" /></TD>
			</TR>
		</TABLE>
		<br>
