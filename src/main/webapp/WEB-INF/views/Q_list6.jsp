	...
	<form id="user" Method="post" Name="joinForm"
		...
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_6/6-11.png" onclick="Check()"></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_6/6-22.png" onclick="Check2()"/></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_6/6-33.png" onclick="Check3()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_6/6-44.png" onclick="Check4()" /></TD>
			</TR>
		</TABLE>
		<br>
		<TABLE border='0'>
			<TR>
				...
				<img src="./resources/images/no_6/6-55.png" onclick="Check5()" /></TD>
			</TR>
		</TABLE>
		<br>
